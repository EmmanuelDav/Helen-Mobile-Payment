...
fun <T> setHomeAdapter(recyclerView: RecyclerView, statement : MutableLiveData<ArrayList<T>>, @LayoutRes layout : Int = R.layout.item_recent, listener: Any){
    if (recyclerView.adapter == null){
        recyclerView.adapter =  UniversalRecyclerAdapter(layout, statement.value ?: ArrayList(), listener)
    }else{
